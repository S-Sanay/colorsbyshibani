...
// Note: metadata export doesn't work in Client Components — move to a separate
// layout.tsx within /contact if SEO is needed here.
...
export default function ContactPage() {
  ...
  function handleSubmit(e: React.FormEvent) {
    e.preventDefault();
    // TODO: wire up to an email service (Resend, Postmark) or Supabase function
    setSubmitted(true);
  }
        ...
        <FadeIn>
          <div className="flex flex-col gap-6">
            ...
            <p className="text-warm-gray leading-relaxed max-w-md">
              Interested in purchasing a piece, commissioning something new, or just
              want to say hello? I'd love to hear from you. I read every message and
        ...
        <FadeIn delay={150}>
          {submitted ? (
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-8">
              <div>
                <label htmlFor="name" className="text-xs tracking-widest uppercase text-muted font-sans block mb-2">
                  Name
                </label>
                <input
                  id="name"
              ...
              <div>
                <label htmlFor="email" className="text-xs tracking-widest uppercase text-muted font-sans block mb-2">
                  Email
                </label>
                <input
                  id="email"
              ...
              <div>
                <label htmlFor="message" className="text-xs tracking-widest uppercase text-muted font-sans block mb-2">
                  Message
                </label>
                <textarea
                  id="message"
                  ...
                  value={form.message}
                  onChange={handleChange}
                  placeholder="Tell me about the piece you're interested in, or anything else on your mind."
